          ...
          <div className="text-left">
            <Fade>
              ...
              <p className="text-xl text-gray-300">
                I&apos;m a passionate fullstack software engineer with expertise in building
            ...
            <div>
              ...
              <div className="space-y-4 text-gray-300">
                <p>
                  ...
                  robust, scalable applications using cutting-edge technologies. My journey began
                ...
                <p>
                  ...
                  architecting backend systems, I approach each project with attention to detail and
                  a much more focus on user experience.
                </p>
                <p>
                  When I&apos;m not coding, you can find me exploring new technologies, breaking
                  things and fixing them, or sharing knowledge with the developer community through
                  my blog and retweets.
                </p>
              </div>
            </div>
          </Fade>
